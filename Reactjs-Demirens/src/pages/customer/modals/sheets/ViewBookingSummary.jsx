      ...
      <SheetContent className='w-full h-[90vh] rounded-t-lg overflow-y-auto bg-gray-50' side='bottom'>
        ...
        <div className="flex flex-col w-full max-w-[1200px] mx-auto px-4 sm:px-6">
          ...
          <div className="flex justify-center items-center mb-6">
            <Card className="w-full bg-white rounded-lg border border-gray-100 shadow-sm hover:shadow-md transition">
              <CardContent className="p-4 sm:p-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center gap-3 p-3 bg-white rounded-lg border">
                    ...
                    <div>
                      <Label className="text-xs sm:text-sm text-gray-500 uppercase">Check Out</Label>
                      <p className="text-sm sm:text-base font-medium text-gray-900 break-words">{data.booking_checkout_dateandtime}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 items-stretch w-full'>
            {roomsList.map((room, index) => (
              <Card key={index} className="w-full h-full relative overflow-hidden rounded-lg border border-gray-100 bg-white shadow-sm hover:shadow-md transition">
                ...
                <CardContent className="p-4 sm:p-5">
                  ...
                  <div className="flex items-center gap-3 mb-4 pb-3 border-b">
                    ...
                    <div className="flex-1">
                      ...
                      <CardDescription className="text-gray-600 text-sm break-words">
